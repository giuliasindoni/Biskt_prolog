...
%% True implication, Non-destructive
...
test_object2( [available = [i: (and(p1, p2) = t), i:(p1 = t), i:(p2=t)], used=[], relations = [h(i,i), h(i, j)] ] ).
...
test_object10( [available = [ i:(or(p1,p2) = t), i:(p1=t), i:(p2= t)], used=[], relations = [] ] ).
